...
sealed class WhisperTranscribeSegment with _$WhisperTranscribeSegment {
  ///
  ...
  factory WhisperTranscribeSegment.fromJson(Map<String, dynamic> json) => _$WhisperTranscribeSegmentFromJson(json);
