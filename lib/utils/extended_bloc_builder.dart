...
class ExtendedBlocBuilder<B extends BaseCommandBloc<C, S>, S, C> extends _BlocBuilderBase<B, S, C> {
...
abstract class _BlocBuilderBase<B extends BaseCommandBloc<C, S>, S, C> extends StatefulWidget {
  const _BlocBuilderBase({Key? key, this.bloc, this.buildWhen, this.commandListener}) : super(key: key);
...
class _BlocBuilderBaseState<B extends BaseCommandBloc<C, S>, S, C> extends State<_BlocBuilderBase<B, S, C>> {
  late B _bloc;
  late S _state;
